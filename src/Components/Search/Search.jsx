...
const Search = ({ saveid, theme}) => {
    ...
    return (
        <div className="w-full max-w-6xl mx-auto lg:mx-0 flex items-center px-4 sm:px-24 lg:px-0">
            <div className="border shadow-2xl border-2 border-gray-500 flex flex-col rounded-lg justify-around h-full w-full relative p-6 sm:p-12 bg-transparent">
                {/* Título */}
                ...
                <div className="">
                    <p className="inter text-lg sm:text-2xl bg-gradient-to-r from-white to-gray-300 bg-clip-text text-transparent break-words">
                ...
                <div className="">
                    <p className="text-sm sm:text-base inter bg-gradient-to-r from-white to-gray-300 bg-clip-text text-transparent break-words">
                ...
                <div className="mt-4 shadow-2xl w-full sm:w-2/3 h-14 flex">
                    <input
                        ...
                        className="w-full pl-4 border border-purple-500 rounded-l-lg focus:ring-0 focus:outline-none bg-transparent text-white placeholder-gray-400 text-xs sm:text-sm"
                    />
                    <button
